            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Info Office</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-dark">
                ...
                <form action="{{ route('office.update',compact('office')) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    @method('PUT')
                <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="address1" name="address1" class="form-control" placeholder="Address :"
                                           value="{{ (old('address1')) ?? $office->address1 }}" required/>
                                </div>
                                <!-- /.form-group -->
                                @error('address1')
                                <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="address2" name="address2" class="form-control"
                                           placeholder="Address Ling 2 :"
                                           value="{{ (old('address2')) ?? $office->address2 }}" />
                                </div>
                                <!-- /.form-group -->
                                @error('address2')
                                <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <select id="country" name="country" class="form-control select2 select2-purple"
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country->id }}"
                                                    {{ ($office->country_id === $country->id) ? 'seleced' : '' }}>
